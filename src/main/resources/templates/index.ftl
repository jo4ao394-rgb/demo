...
<div class="navbar navbar-light bg-light navbar-expand-lg">
  <div class="container-fluid"><a class="navbar-brand">SpingBoot商城</a>
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarText">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" id="user-info-link" href="#"></a>
        </li>
...
<hr style="border: 0; height: 2px; background: linear-gradient(to right, transparent, #ff502f, transparent); margin: 30px auto; width: 80%;">

<section id="other_product">
  <div class="container">
    <div class="header">其他商品</div>
    <div class="d-flex row" id="other-list">
      <div class="content col-md-2">
        <div class="title">#title </div>
        <div class="price">#price</div><a class="d-flex justify-content-end" href="">查看商品</a>
      </div>
